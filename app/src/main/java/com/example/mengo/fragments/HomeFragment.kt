package com.example.mengo.fragments
...
import com.example.mengo.MenuBottomSheetFragment
import com.example.mengo.R
import com.example.mengo.adapters.MenuBottomAdapter
import com.example.mengo.adapters.PopularAdapter
import com.example.mengo.databinding.FragmentHomeBinding
import com.example.mengo.model.MenuItems
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        imageList.add(SlideModel(R.drawable.canva1, ScaleTypes.FIT))
        imageList.add(SlideModel(R.drawable.canva2, ScaleTypes.FIT))
        imageList.add(SlideModel(R.drawable.canva3, ScaleTypes.FIT))
