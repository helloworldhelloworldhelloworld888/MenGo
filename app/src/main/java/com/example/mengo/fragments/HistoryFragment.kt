...
import com.example.mengo.RecentOrderItemsActivity
import com.example.mengo.adapters.BuyAgainAdapter
import com.example.mengo.databinding.FragmentHistoryBinding
...
class HistoryFragment : Fragment() {
    ...
    private fun updateOrderStatus() {
        ...
        val completeOrderReference =
            database.reference.child("Completed Orders").child(itemPushKey!!)
    ...
    private fun setDataInRecentBuyItem() {
        ...
        recentOrderItem?.let {
            with(binding) {
                ...
                recentPrice.text = "Rp "+ it.foodItemPrice?.firstOrNull() ?: ""
