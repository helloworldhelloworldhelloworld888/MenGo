...
import com.example.mengo.adapters.NotificationAdapter
import com.example.mengo.databinding.FragmentNotificationBinding
...
class NotificationFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        val images =
            listOf(R.drawable.sad_emoji, R.drawable.delivery_green, R.drawable.success_illu)
