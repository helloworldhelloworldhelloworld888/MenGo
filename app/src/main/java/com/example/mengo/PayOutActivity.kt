...
import com.example.mengo.databinding.ActivityPayOutBinding
import com.example.mengo.fragments.CartFragment
import com.example.mengo.fragments.HomeFragment
...
class PayOutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        totalAmounts = "Rp "+ calculateTotalAmount().toString()
...
//        binding.totalAmount.isEnabled= false
    ...
    private fun calculateTotalAmount(): Int {
        ...
        for (i in 0 until foodItemPrice.size) {
            ...
            val priceIntValue =
                price.filter { it.isDigit() }.takeIf { it.isNotEmpty() }?.toIntOrNull() ?: 0
