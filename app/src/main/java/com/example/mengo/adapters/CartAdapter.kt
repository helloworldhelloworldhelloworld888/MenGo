package com.example.mengo.adapters
...
import com.example.mengo.databinding.CartItemBinding
    ...
    inner class CartViewHolder(private val binding: CartItemBinding) :
        ...
        fun bind(position: Int) {
            ...
            binding.apply {
                ...
                cartPrice.text = "Rp " + price[position]
...
//                Log.d("image", "food Url: $uriString")
        ...
        fun Int.formatAsCurrency(): String {
           ...
           return "Rp ${String.format("%d", this)}"
        }
        ...
        private fun increaseQuantity(position: Int) {
            if (itemQuantits[position] < 10) {
                ...
                // Update cart price
                val unitPrice = price[position].replace("[^\\d]".toRegex(), "").toInt()
                val updatedPrice = unitPrice * itemQuantits[position]
                binding.cartPrice.text = "${updatedPrice.formatAsCurrency()}"
            }
        }
...
//                    notifyItemRemoved(cartQuantity[position])
                    ...
                    cartQuantity =
                        cartQuantity.filterIndexed { index, i -> index != position }.toMutableList()
